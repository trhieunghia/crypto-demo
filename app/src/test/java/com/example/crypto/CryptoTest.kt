...
import com.example.crypto.Crypto.checkHmac
import com.example.crypto.Crypto.createHmac
import com.example.crypto.Crypto.decryptCbc
import com.example.crypto.Crypto.decryptGcm
import com.example.crypto.Crypto.encryptCbc
import com.example.crypto.Crypto.encryptGcm
import com.example.crypto.Crypto.generateKey
...
class CryptoTest {
    ...
    fun testCbcAndHmac() {
        ...
        if (!checkHmac(
                ciphertext.iv + ciphertext.ciphertext,
                hmacKey,
                hmac
            )
